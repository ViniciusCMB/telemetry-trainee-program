...
- [Calendário do treinamento](calendario.md)
- [FAQ](faq.md)
- [Checklist GitHub Pages](checklist-github-pages.md)
- [Mapa Geral](mapa-geral.md)
...
- [Boas Praticas de PR](boas-praticas-pr.md)
- [Padrao de Branches e PRs](padrao-branches-prs.md)
- [Guia do Instrutor](guia-instrutor.md)
- [Auditoria das Trilhas](auditoria-trilhas.md)

## Templates

- [Template de Issue](../templates/issue-template.md)
- [Template de Issue Semanal](../templates/issue-semanal-modelo.md)
- [Template de PR](../templates/pr-template.md)

## Princípios do treinamento

- Entregas semanais com issues e PRs
- Base comum: Python, Arduino, PlatformIO, KiCad, GitHub
- Revisão semanal de PR para mentoria e alinhamento
